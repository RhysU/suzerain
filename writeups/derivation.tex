...
discretization choices have successfully employed Giles' approach on our
problems of interest.  The practical performance of the two methods for
Suzerain's problems of interest is expected to be nearly identical.  If
necessary, Rowley and Colonius~\cite{Rowley2000Discretely} review several
higher order techniques expected to perform better than the selected approach.
In section 4.3.2 of his thesis, Guarini~\cite{Guarini1998} extended Giles'
analysis to three directions with $y$ being the inhomogeneous direction.  We
review Giles' approach following Guarini.  For complete details, especially
motivations and proofs, the papers of Giles, Guarini's thesis, and a
particularly lucid catalog of results by Medida~\cite{Medida2007} should be
consulted.
...
$-\ii\omega$, Fourier transforming in time, and using linearity gives the
...
truncations of this form lead to well-posed conditions.
