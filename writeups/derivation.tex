...
\label{eq:dimeulerdisp}
  ...
  .
\end{align}
Applying $- \left(\ii\omega{}B_0\right)^{-1}$ to
equation~\eqref{eq:dimeulerreduced}, one finds a family of eigenvalue problems
in $\lambda_y$
\begin{align}
  \left(   B_0^{-1}
         - \lambda_x B_0^{-1} A_0
...
$$
\begin{bmatrix}
 -\frac{-1+u {\lambda_x}+w {\lambda_z}}{v} & \frac{v {\lambda_x} \rho }{a^2-v^2} & -\frac{(-1+u {\lambda_x}+w {\lambda_z}) \rho }{a^2-v^2} & \frac{v {\lambda_z} \rho }{a^2-v^2} & \frac{-1+u {\lambda_x}+w {\lambda_z}}{v \left(a^2-v^2\right)} & 0 \\
 0 & -\frac{-1+u {\lambda_x}+w {\lambda_z}}{v} & 0 & 0 & -\frac{{\lambda_x}}{v \rho } & 0 \\
 0 & -\frac{a^2 {\lambda_x}}{a^2-v^2} & \frac{v (-1+u {\lambda_x}+w {\lambda_z})}{a^2-v^2} & -\frac{a^2 {\lambda_z}}{a^2-v^2} & -\frac{-1+u {\lambda_x}+w {\lambda_z}}{a^2 \rho -v^2 \rho } & 0 \\
