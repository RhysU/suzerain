...
represent transport of the turbulent kinetic energy density $k$, defined below,
and viscous stress work due to turbulent velocity fluctuations, respectively.
...
.
\end{align}
Rearranging this result to mimic some terms within~\eqref{eq:fanstke1}
\begin{align}
  - \overline{u''}\cdot\nabla\bar{p}
  - \nabla\cdot\overline{p'u''}
&=
...
when working with pressure correlation closures.
