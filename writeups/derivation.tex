...
observed stability issues arising from the total energy equation while treating
the latter two terms explicitly.  We implicitly treat the latter two terms
to unify the numerics across the momentum and energy equations and to acquire
...
& \entry{e\mx   }
  \subcoeff{
    \begin{pmatrix}
      - \ii\km\C{e}{\nabla\cdot{}m}
      + \left(\frac{\g\Ma^2}{\Re\Pr} - \frac{\Ma^2}{\Re}\right)
    ...
    - \left(\frac{\g\Ma^2}{\Re\Pr} - \frac{\Ma^2}{\Re}\right)\C{\nu{}u_x}{}
  }
& \entry{e\my   }
  \subcoeff{
    \left(\frac{\g\Ma^2}{\Re\Pr} - \frac{\Ma^2}{\Re}\right)
