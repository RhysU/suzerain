...
&=
  ...
  - \nabla\cdot\left(
    ...
    \right)
  + \nabla\cdot\left(
        -\frac{1}{2}\overline{\left(u''\otimes\rho{}u''\right)u''}
      + \overline{\tau{}u''}
    \right)
\end{align}
\end{subequations}
...
$-\frac{1}{2}\overline{\left(u''\otimes\rho{}u''\right)u''}$, and turbulent
work $\overline{\tau{}u''}$.  The Reynolds stress and heat flux augment the
viscous stress and heat flux, respectively.  The turbulent transport and work
terms represent transport of the turbulent kinetic energy
...
re-express~\eqref{eq:taunewt} and~\eqref{eq:secondviscosityclaw} as
\begin{align}
  \tau
&= \mu \left( \nabla{}u+\trans{\nabla{}u} \right)
...
.
\end{align}
Note that many FANS closure approximations neglect correlations between the
kinematic viscosity and velocity derivatives and also assume $\alpha=0$.  Those
approximations will eliminate the second through fourth terms in $\bar{\tau}$.
