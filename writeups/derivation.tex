...
density $\widetilde{h''u''}$, turbulent transport
...
flux density in the exact $k$ equation:
\begin{align}
\label{eq:fanstke}
    \frac{\partial{}}{\partial{}t}\bar{\rho}k
  + \nabla\cdot(\tilde{u}\otimes\bar{\rho}k)
...
\end{align}
which is not computable given only Favre-averaged state.  A commonly accepted
