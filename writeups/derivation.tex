...
Reynolds stress $-\bar{\rho}\widetilde{u''\otimes{}u''}$, the Reynolds heat
flux $\bar{\rho} \widetilde{h''u''}$, turbulent transport
$-\frac{1}{2}\bar{\rho}\widetilde{{u''}^{2}u''}$, and turbulent work
...
simplifying assumption is taking $\overline{\mu\left(T\right)} \approx
