...
We now need to average the constitutive relations chosen in
...
.
\end{align}
Rearranging this result to mimic the pressure terms in the $k$ equation
\begin{align}
  - \overline{u''}\cdot\nabla\bar{p}
  - \nabla\cdot\overline{p'u''}
&=
...
- \frac{\gamma-1}{\gamma} \nabla\cdot \bar{\rho} \widetilde{h''u''}
\end{align}
we may trade an ocurrance of $\overline{p'u''}$ for the Reynolds heat flux:
\begin{align}
\label{eq:fanstke}
    \frac{\partial{}}{\partial{}t}\bar{\rho}k
  + \nabla\cdot(\tilde{u}\otimes\bar{\rho}k)
