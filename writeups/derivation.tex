...
Trefethen and Halpern~\cite{Trefethen1986Wellposedness}, only some truncated
approximations lead to well-posed conditions.

Multiplying through by $-\ii\omega$, Fourier transforming in time,
and using linearity gives Giles' result
\begin{align}
...
An implementation of the boundary conditions~\eqref{eq:dimeulerapprox} requires
