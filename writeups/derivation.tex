...
\end{align}
\begin{align}
  p &= \frac{\rho_0 a_0^2  \rho^{*} T^{*}}{\gamma}
     ...
     + \frac{\rho_0 u_0^2}{2\rho^{*}}\left(1-\gamma\right)\left(
       ...
       \right)
\end{align}
The Jacobian for this transformation evaluated at reference $\bar{U}$ is
\begin{align}
S = \frac{\partial{}U}{\partial{}V} &= \left[\begin{array}{ccccc}
  ...
  & 0                    % 45
  \\ \noalign{\medskip}
    \frac{\rho_0 a_0^2 T^{*}}{\gamma}          % 51
  & \rho_0 u_0^2 \left(1 - \gamma\right) u^{*} % 52
  & \rho_0 u_0^2 \left(1 - \gamma\right) v^{*} % 53
  & \rho_0 u_0^2 \left(1 - \gamma\right) w^{*} % 54
