...
allows efficient banded factorization and back substitution.
...
up in the simulation.  A non-physical partition of the energy into acoustic and
non-acoustic flavors which weakly interact results and spoils the utility of
...
are selected over Poinsot and Lele's locally one-dimensional inviscid (LODI)
relations~\cite{Poinsot1992Boundary} because Giles' approach closely matches
our discretization choices and because other codes with identical
discretization choices have successfully employed it.
...
Equation 4.81).  Guarini further rotated the nonreflecting boundary to match
the nonorthogonal coordinate system used for his spatially-homogenized boundary
...
system is unnecessary.  We need to translate Guarini's orthogonal, dimensional
results to Suzerain's state variable and nondimensionalization choices.
