...
We now turn back to constitutive relations.  Combining~\eqref{eq:tauSmub}
...
state evolution given the following information:
\begin{align}
&\bar{\rho}
&
&\tilde{u}
...
have been replaced by temperature-based correlations.  Where possible,
nondimensional coefficients have been pulled out of the constitutive
relationships and pushed into the equations (for example, the factor
$1/\Reynolds$ arising from the dimensional definition of $\bar{\rho}\epsilon$).
