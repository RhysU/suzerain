...
.
\end{align}
Two of the roots come from a quadratic equation with discriminant
FIXME.

The characteristic polynomial zero of multiplicity four evidently yields the four remaining eigenvalues
\begin{align}
\lambda_{3,4,5,6}
=
