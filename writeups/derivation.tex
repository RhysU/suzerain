...
$$
and any orthogonal transformation $R$ may be used to rewrite the exact
nonreflecting conditions~\eqref{eq:dimeulerexact} as
\begin{align}
...
\label{eq:dimeulertransform}
  ...
  .
\end{align}
Using notation and matrices from the compact characteristic
...
\label{eq:dimeulertransformcharnot}
  ...
  .
\end{align}
Substituting $\delta{}V = V - V_0$ and taking advantage of the steadiness and
uniformity of the reference state $V_0$,
\begin{align}
\label{eq:dimeulertransformcharstate}
  V^L
  S R
  \frac{\partial}{\partial{}t}
  V
