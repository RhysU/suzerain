...
Computing $\overline{\rho{}u''\otimes{}u''\otimes{}u''}$, a superset of the
information required to obtain $-\frac{1}{2}\widetilde{{u''}^{2}u''}$, is more
involved.  Employing the summation convention and ignoring any symmetry-related
simplifications, it holds that
\begin{align}
  \bar{\rho}\widetilde{u_{i}u_{j}''}
  &= \bar{\rho}\widetilde{u_{i}u_{j}} - \bar{\rho}\tilde{u}_{i}\tilde{u}_{j}
\\
  \bar{\rho}\widetilde{u_{i}u_{j}u_{k}''}
  &= \bar{\rho}\widetilde{u_{i}u_{j}u_{k}}
   - \bar{\rho}\widetilde{u_{i}u_{j}}\tilde{u}_{k}
\\
  \bar{\rho}\widetilde{u_{i}''u_{j}''u_{k}''}
  &= \overline{\left(u_{i}-\tilde{u}_{i}\right)
               \left(u_{j}-\tilde{u}_{j}\right)
               \rho{}u_{k}''}
\\
  &= \bar{\rho}\widetilde{u_{i}u_{j}u_{k}''}
   - \tilde{u}_i \bar{\rho} \widetilde{u_{j}u_{k}''}
   - \tilde{u}_j \bar{\rho} \widetilde{u_{i}u_{k}''}
%%\\
%%  &= \bar{\rho}\widetilde{u_{i}u_{j}u_{k}}
%%   - \bar{\rho}\widetilde{u_{i}u_{j}}\tilde{u}_{k}
%%   - \bar{\rho} \tilde{u}_{i} \widetilde{u_{j} u_{k}}
%%   + \bar{\rho} \tilde{u}_{i}\tilde{u}_{j}\tilde{u}_{k}
%%   - \bar{\rho}\tilde{u}_{j} \widetilde{u_{i}u_{k}}
%%   + \bar{\rho}\tilde{u}_{j} \tilde{u}_{i}\tilde{u}_{k}
\\
  &= \bar{\rho} \widetilde{u_{i}u_{j}u_{k}}
   - \bar{\rho} \widetilde{u_{i}u_{j}}\tilde{u}_{k}
   - \bar{\rho} \tilde{u}_{i} \widetilde{u_{j} u_{k}}
   - \bar{\rho} \tilde{u}_{j} \widetilde{u_{i}u_{k}}
   + 2 \bar{\rho} \tilde{u}_{i} \tilde{u}_{j}\tilde{u}_{k}
.
\end{align}
We find $\widetilde{{u''}^{2}u''}$ by contracting the on the first two indices,
relabelling the third index, and dividing by $\bar{\rho}$,
\begin{align}
  ...
  &= \widetilde{u_{i}u_{i}u_{j}}
   ...
   .
\end{align}
Finally, reverting to direct notation, employing symmetry, and multiplying by
negative one half,
\begin{align}
  -\frac{1}{2}\widetilde{{u''}^{2}u''}
&=
  - \frac{1}{2}\widetilde{u^{2}u}
  + \frac{1}{2}\widetilde{u^{2}}\tilde{u}
  + \widetilde{u\otimes{}u}\tilde{u}
  - \tilde{u}^2 \tilde{u}
\end{align}
where $\widetilde{u^{2}u}$ and $\widetilde{u^2}$ may be computed from
$\overline{\rho{}u\otimes{}u\otimes{}u}$ and $\overline{\rho{}u\otimes{}u}$,
respectively.
