...
warranted by the associated programming and runtime overhead.  We will catalog
both on- and off-diagonal linearized terms and later detail which specific ones
...
We now to focus on the first order acoustic terms within the
...
\subsubsection{Acoustic linearizations chosen for implicit treatment}
