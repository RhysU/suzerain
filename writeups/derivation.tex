...
(``LODI'') relations~\cite{Poinsot1992Boundary} because other codes with
identical discretization choices have successfully employed Giles' approach on
our problems of interest.  The practical performance of the two methods is
expected to be nearly identical.  In section 4.3.2 of his thesis,
Guarini~\cite{Guarini1998} extended Giles' analysis to three directions with
$y$ being the inhomogeneous direction.  We review Giles' approach following
Guarini.  For complete details, especially motivations and proofs, the papers
of Giles, Guarini's thesis, and a particularly lucid catalog of results by
Medida~\cite{Medida2007} should be consulted.
