...
.
$$
The characteristic polynomial expressed as a function of unadorned $\lambda$ is
\begin{align}
-\left(\frac{-1+u {\lambda_x}+v {\lambda}+w {\lambda_z}}{v}\right)^4
\frac{1}{a^2-v^2} \biggl(
     u^2 {\lambda_x}^2
  &+ 2 u {\lambda_x} \left(-1+v {\lambda}+w {\lambda_z}\right)
\\
  &+ \left(-1+v {\lambda}+w {\lambda_z}\right)^2
   - a^2 \left({\lambda_x}^2+{\lambda}^2+{\lambda_z}^2\right)
\biggr)
= 0
.
\end{align}
The zero of multiplicity four evidently yields four identical eigenvalues
\begin{align}
\lambda_{3,4,5,6}
=
...
\begin{align}
{\lambda_{1,2}}^2
+ \lambda_{1,2} \frac{2 v  \left(u {\lambda_x}+w {\lambda_z}-1\right)}{v^2-a^2}
