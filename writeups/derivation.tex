...
\subsection{The unclosed Favre-averaged Navier--Stokes equations}
...
viscous stress and heat flux, respectively.  The turbulent transport term
represents transport of the turbulent kinetic energy
$k=\frac{1}{2}\widetilde{{u''}^2}$ by turbulent velocity fluctuations.  The
turbulent work term represents the work done by the viscous stress due to
turbulent velocity fluctuations.

\subsection{Dimensional equations using Suzerain's constitutive assumptions}
