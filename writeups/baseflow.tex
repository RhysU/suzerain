...
.
\end{align}
% As expected, one obtains the Laplace equation for incompressible,
% irrotational flow on taking $a \to \infty$.
...
\end{align}
which is an awfully nondimensional but pleasantly univariate result.

To put~\eqref{eq:cpfgibbs_nondim} into an axisymmetric setting\dots TODO
