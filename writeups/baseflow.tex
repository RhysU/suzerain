...
$\left(x,y\right)$ coordinates and a base flow profile along some constant
...
$\left(R_0,\delta\right)$ without requiring the integrator to possess dense
output capabilities.
...
quantified as a function of leeward arc length from the stagnation region
measured in meters.
...
thickness $\delta$ is supplied.  The other parameters, discussed by many
authors including \citet{Sreenivasan1982Laminarescent}, were not adopted for
matching purposes as they require more-complicated flow descriptors like
$\delta^\ast$ and $\tau_w$ or the numerically-noisy
