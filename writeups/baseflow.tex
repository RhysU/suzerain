...
.
\end{align}
Inserting the scalar potential into the continuity equation and employing
smoothness,
\begin{align}
  0 &= \vec{\nabla}\cdot\rho\vec{u}
     = \vec{\nabla}\cdot\rho\vec{\nabla}\phi
...
.
\end{align}
As expected, this is nothing but the Laplace equation for incompressible,
irrotational flow whenever $\vec{\nabla}\rho = 0$.
