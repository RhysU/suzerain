...
\begin{align}
  ...
  .
\end{align}
However, velocity potential notation is here suppressed.  Assume an
isenthalpic flow wherein total specific enthalpy $H$ is constant.  Clearly the
energy equation degenerates to the continuity equation in this circumstance and
is of no further interest. Rearranging~\eqref{eq:eos},
\begin{align}
...
\end{align}
Applying~\eqref{eq:T}, one finally arrives at a velocity equation depending
