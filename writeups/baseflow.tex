...
Following \citeauthor{Saad2011Coordinate}, we assume that specific total
enthalpy $H$ stays constant through the flow to connect $a$ and $u$ to a
...
p$, is not imposed and it will not be satisfied in generally.  After a slight
...
possibly different $a_0$ while $\rho_0$ and $u_0$ remain the same.  This
