...
compressible potential flow problem is formulated for an isentropic, radially
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The nondimensional, isentropic, compressible potential flow equations}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{align}
    \left(\frac{\partial p}{\partial \rho}\right)_{s} =
          \frac{\partial p}{\partial \rho}            = a^2
    \implies
...
Following \citeauthor{Saad2011Coordinate}, we use that the specific total
enthalpy $H$ stays constant throughout such a flow to connect $a$ and $u$ to a
