...
\section{Example: producing base flows matching laminar CEV heat shield conditions}
...
\pgfplotstabletypeset[
  ...
  columns/dstag/.style=  {fixed,fixed zerofill,precision=3,dec sep align,column name=Location $(m)$},
  columns/Ma_edge/.style={fixed,fixed zerofill,precision=6,dec sep align,column name=$\Mach[e]{}$},
  columns/p_exi/.style=  {fixed,fixed zerofill,precision=6,dec sep align,column name=$p_{e,\xi}$},
  columns/T_ratio/.style={fixed,fixed zerofill,precision=6,dec sep align,column name=$a^2_e$},
  columns/Ma/.style=     {fixed,fixed zerofill,precision=5,dec sep align,column name=$\Mach{}$},
  columns/R0/.style=     {fixed,fixed zerofill,precision=2,dec sep align,column name=$R_0$},
  columns/u1/.style=     {fixed,fixed zerofill,precision=5,dec sep align,column name=$u\!\left(R_1\right)$},
  columns/res2/.style=   {sci,  sci   zerofill,precision=0,dec sep align,column name=Residual}
