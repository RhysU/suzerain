...
the assumption that $p_0 = \rho_0 a_0^2$ still holds in that setting and
further that identical choices have been made for $\rho_0$ and $u_0$.
%
...
\pgfplotstabletypeset[
  ...
  columns/Ma/.style=     {fixed,fixed zerofill,precision=5,dec sep align,column type/.add={}{},column name=$\Mach[0]{}$},
