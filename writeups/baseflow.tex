...
measured in meters.  The general flow nature is plotted in
Figure~\ref{fig:cev_summary1} with details on the observed favorable pressure
gradient magnitude appearing in Figure~\ref{fig:cev_summary_fpg}.

\textcolor{red}{STARTHERE}
