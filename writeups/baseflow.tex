...
\begin{align}
    T\!\left(R\right) &< \gamma_0 \Mach^2 \left(
      \frac{1}{2} + \frac{1}{\Mach[0]{}\left(\gamma_0 - 1\right)}
         \right)
\label{eq:Terestrict}
.
\end{align}
...
\lstinputlisting[language=Octave,label=lst:octave_nozzle_match,float,
...
\begin{figure}[p]
  \centering
  \includegraphics[height=0.85\textheight]{symplanenorm}
  \caption{
