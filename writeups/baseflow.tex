...
succinct, its $\rho$ and $p$ solution accuracies are not controlled in the same
manner its $u$ accuracy.  By coupling $u'$, $\left(\log\rho\right)'$, and $p'$
one may achieve higher order behavior across all three scalars as shown in
...
\begin{figure}[p]
  ...
  \caption{
      ...
      Sample radial nozzle solutions produced by \texttt{nozzle1.m}.  The
      subsonic solution flows from right-to-left while the supersonic one flows
      from left-to-right.
  }
\end{figure}
