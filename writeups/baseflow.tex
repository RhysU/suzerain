...
solve such problems.  Stiffness can be mitigated with implicit integrators
which can benefit the analytic Jacobian $u''$ obtained
from~\eqref{eq:cpfradial_nondim_ode},
\begin{multline}
  u''
  =
...
.
\end{multline}
Here smoothness has been invoked to eliminate the appearance of $u'$.  Sample
solutions based on code in Listing~\ref{lst:octave_nozzle} appear in
