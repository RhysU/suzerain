...
in Listing~\ref{lst:octave_nozzle1}.  Listing~\ref{lst:octave_nozzle_usecase}
demonstrates solving concrete problems producing the solutions depicted in
Figure~\ref{fig:sample_solns}.  While Listing~\ref{lst:octave_nozzle1} is
succinct, the discrete $\rho$ and $p$ solution accuracies are not controlled in
the same manner as those for $u$.  By coupling $u'$, $\left(\log\rho\right)'$,
and $p'$ one may achieve higher order behavior across all three scalars as
shown in Listing~\ref{lst:octave_nozzle}.
