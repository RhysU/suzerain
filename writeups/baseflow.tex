...
\lstinputlisting[language=Octave,columns=fixed,float=p,showstringspaces=false,
...
\lstinputlisting[language=Octave,columns=fixed,float,showstringspaces=false,
...
\lstinputlisting[language=Octave,columns=fixed,showstringspaces=false,%NO float,
