...
demonstrates using that implementation to solve concrete problems.  The
solutions are depicted in Figure~\ref{fig:sample_solns}.

\lstinputlisting[language=Octave,columns=fixed,float,
                 caption={\texttt{nozzle.m}: A radially-symmetric nozzle solver
...
\lstinputlisting[language=Octave,columns=fixed,float,
                 caption={\texttt{nozzle\_edge.m}: A driver computing edge
