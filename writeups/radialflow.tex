...
realizable specific total energy~$E$ can be a concern when dictating $T_e$ in
this manner as combining~\eqref{eq:constant_specific_stagnation_enthalpy}
nondimensionalized by $a_0^2$ with the constant-by-assumption $H =
E\!\left(R\right) + p\!\left(R\right)/\rho\!\left(R\right)$ shows that
\begin{align}
    E\!\left(R\right)>0
&\implies
