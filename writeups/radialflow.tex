...
\begin{align}
    T_e &= \gamma \frac{p\!\left(x,y;\Mach\right)}{\rho\!\left(x,y\right)}
         = \left. \gamma \frac{\Mach^2    p   \!\left(R\right)}
...
scaled by $\gamma \Mach^2 \Mach[0]^{-2}$, is equivalent to
\begin{align}
    T\!\left(R\right) < \gamma \Mach^2 \left(
      \frac{1}{2} + \frac{\theta}{\Mach[0]^2\left(\gamma - 1\right)}
         \right)
\label{eq:Terestrict}
.
\end{align}
...
\begin{align}
   ...
   &= \theta + \Mach[0]^2\frac{\gamma-1}{2}\left(1-u^2\!\left(R\right)\right)
\\ &= \theta + \Mach[0]^2\frac{\gamma-1}{2}\left(1-\frac{R^2}{R_0^2}\right)
\\ &= \theta - \Mach[0]^2\frac{\gamma-1}{2}\frac{\delta^2}{R_0^2}
\end{align}
forces
\begin{align}
    \Mach[0] &= \left[
