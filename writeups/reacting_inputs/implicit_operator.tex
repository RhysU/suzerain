...
We examine two possibilities: coupling all five flow equations and
coupling only the conservation of mass, wall-momentum, and energy
equations.

In both cases, the analysis begins from the full inviscid flux
Jacobian for the $y$-component (i.e., wall-normal) flux.  The full
flux Jacobian is
%
\begin{equation}
\tiny
...
\subsubsection{Species/Flow Decoupling}
