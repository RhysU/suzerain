 ...
 *--------------------------------------------------------------------------
 *
 * gbiddmv.h: provides custom, BLAS-like general band matrix-vector operations
 *
 * $Id$
 *--------------------------------------------------------------------------
 *-------------------------------------------------------------------------- */

#ifndef __SUZERAIN_GBIDDMV_H__
#define __SUZERAIN_GBIDDMV_H__
