...
//              NONINTERLEAVEDSTATE_ADD_SCALED_NOT_OVERLOADED_FOR_TYPE,
//              (OtherDerived));
//  }
...
//  {
//      BOOST_MPL_ASSERT_MSG(sizeof(OtherDerived) == 0,
//              NONINTERLEAVEDSTATE_ASSIGN_NOT_OVERLOADED_FOR_TYPE,
//              (OtherDerived));
//  }
...
//  {
//      BOOST_MPL_ASSERT_MSG(sizeof(OtherDerived) == 0,
//              NONINTERLEAVEDSTATE_EXCHANGE_NOT_OVERLOADED_FOR_TYPE,
//              (OtherDerived));
//  }
...
//  {
//      BOOST_MPL_ASSERT_MSG(sizeof(OtherDerived) == 0,
//              INTERLEAVEDSTATE_ADD_SCALED_NOT_OVERLOADED_FOR_TYPE,
//              (OtherDerived));
//  }
...
//  {
//      BOOST_MPL_ASSERT_MSG(sizeof(OtherDerived) == 0,
//              INTERLEAVEDSTATE_ASSIGN_NOT_OVERLOADED_FOR_TYPE,
//              (OtherDerived));
//  }
...
//  {
//      BOOST_MPL_ASSERT_MSG(sizeof(OtherDerived) == 0,
//              INTERLEAVEDSTATE_EXCHANGE_NOT_OVERLOADED_FOR_TYPE,
//              (OtherDerived));
//  }
