...
/*! \copydoc suzerain_blasext_sge_diag_scale_acc */
void
 ...
 * \f$ for real general \f$A\f$, real diagonal \f$D_0\f$, real diagonal
 * \f$D_1\f$, and complex general \f$B\f$.  Real-valued strides are in units of
 * <tt>double</tt> while complex-valued strides are in units of
 * <tt>double[2]</tt>.
 *
 * Matrices \f$ A \f$ and \f$ B \f$ both have general storage.  Any matrix may
 ...
 * D_2) + \beta{}B \f$ for real general \f$A\f$, real diagonal \f$D_0\f$, real
 * diagonal \f$D_1\f$, real diagonal \f$D_2\f$,  and complex general \f$B\f$.
 * Real-valued strides are in units of <tt>double</tt> while complex-valued
 * strides are in units of <tt>double[2]</tt>.
 *
 * Matrices \f$ A \f$ and \f$ B \f$ both have general storage.  Any matrix may
