 ...
 *--------------------------------------------------------------------------
 *
 * exprparse_ldstr.cpp: arithmetic expression evaluation for long double, string*
 *
 * $Id$
 *--------------------------------------------------------------------------
 *-------------------------------------------------------------------------- */
...
void suzerain::exprparse(const std::string& s, long double& v, const char *name)
{
    v = suzerain::detail::exprparse_impl<long double>(s, name);
}
