 ...
 * \right) \begin{bmatrix} I & 0 \\ 0 & 1 + \gamma \end{bmatrix}
 * A x + \beta{} y \f$.
 *
 ...
 * D_1\right) \begin{bmatrix} I & 0 \\ 0 & 1 + \gamma \end{bmatrix} A x +
 * \beta{} y \f$ for complex \f$\alpha{}\f$, \f$\beta\f$, and \f$y\f$ but
 * real-valued \f$\gamma\f$, \f$D_0\f$, \f$D_1\f$, \f$A\f$, and \f$x\f$.
 *
 ...
 * \brief Compute \f$ y \leftarrow{} \left(\alpha_{0} D_0 + \alpha_{1}
 * D_1\right) \begin{bmatrix} I & 0 \\ 0 & 1 + \gamma \end{bmatrix} A x +
 * \beta{} y \f$ for complex \f$\alpha{}\f$, \f$x\f$, \f$\beta\f$, and \f$y\f$
 * but real-valued \f$\gamma\f$, \f$D_0\f$, \f$D_1\f$, and \f$A\f$.
 *
 * \copydetails suzerain_gbddmv_s
 */
int
