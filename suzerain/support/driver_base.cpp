...
driver_base::log4cxx_config()
{
    return super::log4cxx_config() + // Append to the default configuration
        ...
        "## Collect \"favre\" messages into only qoi.dat mimicking LOG file behavior\n"
        "## Collect \"prod\"  messages into only qoi.dat mimicking LOG file behavior\n"
        "## Collect \"reyno\" messages into only qoi.dat mimicking LOG file behavior\n"
        "log4j.logger.bl=INHERITED, QOI\n"
        "log4j.additivity.bl=false\n"
        "log4j.logger.chan=INHERITED, QOI\n"
        "log4j.additivity.chan=false\n"
        "log4j.logger.favre=INHERITED, QOI\n"
        "log4j.additivity.favre=false\n"
        "log4j.logger.prod=INHERITED, QOI\n"
        "log4j.additivity.prod=false\n"
        "log4j.logger.reyno=INHERITED, QOI\n"
        "log4j.additivity.reyno=false\n"
