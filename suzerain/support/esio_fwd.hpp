...
#ifndef SUZERAIN_SUPPORT_ESIO_FWD_HPP
#define SUZERAIN_SUPPORT_ESIO_FWD_HPP

/** @file
 * Provides forward declarations for ESIO usage.
 */
...
#endif // SUZERAIN_SUPPORT_ESIO_FWD_HPP
