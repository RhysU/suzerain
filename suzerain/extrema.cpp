...
////
////     // Ensure we were handed Galerkin field_extrema_xyz operator matrices
...
////     std::vector<field_extrema_xyz> retval(state.shape()[0]);
...
////
//// //
//// // Implementation very much resembles compute_field_extrema_xyz.
...
////
////     // Obtain fluctuating2 = total2 - mean2 and pack the return structure
////     std::vector<field_extrema_xz> retval(state.shape()[0]);
////     for (size_t k = 0; k < retval.size(); ++k) {
...
////
//// //
//// // Implementation very much resembles previous compute_field_extrema_xz
