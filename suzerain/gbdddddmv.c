 ...
 *
 *--------------------------------------------------------------------------
 * gbdddddmv.c: provides BLAS-like general band matrix-vector operations
 * $Id$
 */
...
#define GBDDDDDMV_STATIC     static
#define GBDDDDDMV_FUNCTION   suzerain_gbdddddmv_internal_s
#define GBDDDDDMV_COMPONENT  float
#define GBDDDDDMV_SCALAR     float
#define GBDDDDDMV_KL         const int kl,
#define GBDDDDDMV_KU         const int ku,
#define GBDDDDDMV_KAHAN(...) suzerain_kahanf5(__VA_ARGS__)
#include "gbdddddmv.def"

#define GBDDDDDMV_STATIC     static
#define GBDDDDDMV_FUNCTION   suzerain_gbdddddmv_internal_d
#define GBDDDDDMV_COMPONENT  double
#define GBDDDDDMV_SCALAR     double
#define GBDDDDDMV_KL         const int kl,
#define GBDDDDDMV_KU         const int ku,
#define GBDDDDDMV_KAHAN(...) suzerain_kahan5(__VA_ARGS__)
#include "gbdddddmv.def"

#define GBDDDDDMV_STATIC     static
#define GBDDDDDMV_FUNCTION   suzerain_gbdddddmv_internal_sc
#define GBDDDDDMV_COMPONENT  float
#define GBDDDDDMV_SCALAR     complex_float
#define GBDDDDDMV_KL         const int kl,
#define GBDDDDDMV_KU         const int ku,
#define GBDDDDDMV_KAHAN(...) suzerain_kahanc5(__VA_ARGS__)
#include "gbdddddmv.def"

#define GBDDDDDMV_STATIC     static
#define GBDDDDDMV_FUNCTION   suzerain_gbdddddmv_internal_dz
#define GBDDDDDMV_COMPONENT  double
#define GBDDDDDMV_SCALAR     complex_double
#define GBDDDDDMV_KL         const int kl,
#define GBDDDDDMV_KU         const int ku,
#define GBDDDDDMV_KAHAN(...) suzerain_kahanz5(__VA_ARGS__)
#include "gbdddddmv.def"
        ...
        const int incy)
{
    ...
    if (kl == ku) {
        switch (kl) {
            BOOST_PP_REPEAT_FROM_TO(FIXEDBW_LOWER, BOOST_PP_INC(FIXEDBW_UPPER),
                                    FIXEDBW_CASE, suzerain_gbdddddmv_internal_sc)
        }
    }

    // ...otherwise employ a general bandwidth implementation
    return suzerain_gbdddddmv_internal_sc(trans, n, kl, ku,
                                         alpha0, d0, ldd0,
                                         alpha1, d1, ldd1,
                                         alpha2, d2, ldd2,
                                         alpha3, d3, ldd3,
        ...
        const int incy)
{
    ...
    if (kl == ku) {
        switch (kl) {
            BOOST_PP_REPEAT_FROM_TO(FIXEDBW_LOWER, BOOST_PP_INC(FIXEDBW_UPPER),
                                    FIXEDBW_CASE, suzerain_gbdddddmv_internal_dz)
        }
    }

    // ...otherwise employ a general bandwidth implementation
    return suzerain_gbdddddmv_internal_dz(trans, n, kl, ku,
                                         alpha0, d0, ldd0,
                                         alpha1, d1, ldd1,
                                         alpha2, d2, ldd2,
                                         alpha3, d3, ldd3,
...
#define GBDDDDDMV_STATIC    static
#define GBDDDDDMV_FUNCTION  BOOST_PP_CAT(suzerain_gbdddddmv_internal_s, \
                                       BOOST_PP_ITERATION())
#define GBDDDDDMV_COMPONENT float
#define GBDDDDDMV_SCALAR    float
#define GBDDDDDMV_KL
...
#define GBDDDDDMV_STATIC    static
#define GBDDDDDMV_FUNCTION  BOOST_PP_CAT(suzerain_gbdddddmv_internal_d, \
                                       BOOST_PP_ITERATION())
#define GBDDDDDMV_COMPONENT double
#define GBDDDDDMV_SCALAR    double
#define GBDDDDDMV_KL
...
#define GBDDDDDMV_STATIC    static
#define GBDDDDDMV_FUNCTION  BOOST_PP_CAT(suzerain_gbdddddmv_internal_sc, \
                                       BOOST_PP_ITERATION())
#define GBDDDDDMV_COMPONENT float
#define GBDDDDDMV_SCALAR    complex_float
#define GBDDDDDMV_KL
...
#define GBDDDDDMV_STATIC    static
#define GBDDDDDMV_FUNCTION  BOOST_PP_CAT(suzerain_gbdddddmv_internal_dz, \
                                       BOOST_PP_ITERATION())
#define GBDDDDDMV_COMPONENT double
#define GBDDDDDMV_SCALAR    complex_double
#define GBDDDDDMV_KL
