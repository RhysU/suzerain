 ...
 * @param[out] rp  Result \f$\frac{\partial}{\partial\xi} \rho      \f$
 * @param[out] rup Result \f$\frac{\partial}{\partial\xi} \rho u_\xi\f$
 * @param[out] rvp Result \f$\frac{\partial}{\partial\xi} \rho u_y  \f$
 * @param[out] rEp Result \f$\frac{\partial}{\partial\xi} \rho E    \f$
 *
