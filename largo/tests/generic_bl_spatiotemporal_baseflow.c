...
//           {
//             largo_bl_spatiotemporal_ispecies_setamean (generic_workspace, 0.0, 1.0, &srcmean[5+is], is+1);
//           }
...
//           for (int is=0; is < ns; ++is)
//           {
//             largo_bl_spatiotemporal_ispecies_setarms (generic_workspace, 0.0, 1.0, &srcrms[5+is], is+1);
//           }
