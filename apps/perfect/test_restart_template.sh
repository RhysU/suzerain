...
(
    ...
    differ $exclude_datasets                                       \
           ...
           ich0.h5 a0.h5
    differ --delta=5e-16 ich0.h5 a0.h5 /twopoint_kx
    differ --delta=5e-16 ich0.h5 a0.h5 /twopoint_kz
)
...
(
    ...
    differ --delta=5e-16 ich0.h5 b0.h5 /twopoint_kx
    differ --delta=5e-16 ich0.h5 b0.h5 /twopoint_kz
)
