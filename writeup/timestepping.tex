...
We start from equations in Appendix A of Spalart, Moser, and Rogers' 1991
``Spectral Methods for the Navier-Stokes Equations with One Infinite and Two
Periodic Directions'' published in \emph{J. Comput. Phys.} volume 96 pages
297--324.  These equations advance the equation $u_t=Lu+N(u)$ from $u(t)$ to
...
\caption{Compute one substep in the SMR scheme following
         equation \eqref{eq:generaloperatormasssubstep}}
\label{alg:substep}
\begin{algorithmic}
