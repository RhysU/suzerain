...
\end{align}
\end{subequations}
Finally, in table~\vref{tab:nofirstderivnonlinearcost}, we tabulate the specific
state variable derivatives necessary to compute each nonlinear term and all of
its contributions.
