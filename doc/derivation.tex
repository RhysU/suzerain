...
However, because we anticipate $\lambda$ being useful, we will not
combine $\mu$ and $\lambda$ terms in the model.
...
&=
  ...
  + \nabla\cdot{}\tau{} u
  + f \cdot{} u 
\intertext{where terms in the right hand side are computed according to}
