...
operator gives results that differ significantly from application of a discrete
...
We start by expanding the three nonlinear terms:
\begin{subequations}
\begin{align}
  \nabla\cdot\tau
  &=
...
To determine the cost associated with each of these three expressions, we
expand the non-state derivatives appearing above:
\begin{subequations}
\begin{align}
  \nabla{}p &= (\gamma-1)\left[
        \nabla{}e
...
$\left(\nabla\rho\right)^2=\nabla\rho\cdot\nabla\rho$.  Obviously,
not all of the non-state derivatives possess independent information
since
\begin{subequations}
\begin{align}
  \Delta\rho
...
$\nabla\cdot\tau$
% 001 & 002 & 003 & 004 & 005 & 006 & 007 & 008 & 009 & 011 & 012 & 013 & 014
& \cm & \cm & \cd & \cm & \cm & \cm & \cd & \cd & \cm & \cm & \cm & \cm &
& 32 \\
$\nabla\cdot\tau\frac{m}{\rho}$
% 001 & 002 & 003 & 004 & 005 & 006 & 007 & 008 & 009 & 011 & 012 & 013 & 014
& \cm & \cm & \cd & \cm & \cm & \cm & \cd & \cd & \cm & \cm & \cm & \cm &
...
\caption{
  State variable derivatives required to completely compute quantities in
  physical space without repeated first derivative applications
}
