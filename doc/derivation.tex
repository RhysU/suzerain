...
After employing our reference quantity relationships, multiplying the
momentum equation by $\frac{l_{0}}{\rho_{0}a_{0}^{2}}$, and
multipying the energy equation by FIXME
we arrive at the following nondimensional equations:
\begin{subequations}
\begin{align}
...
\intertext{
where $Re=$FIXME.
The nondimensional quantities appearing above are given as follows:
}
