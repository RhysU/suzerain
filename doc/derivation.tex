...
We use nondimensional specific volume $\sigma=1/\rho$, momentum $m=\rho{}u$,
and total energy $e=\rho{}\tilde{e}$ as the state variables for our
computations.  Then the above equations become
\begin{subequations}
\begin{align}
...
&=
  - \nabla\cdot\left(\sigma{}em\right)
  + \frac{1}{Re\,Pr\,\left( \gamma - 1 \right)}
    \nabla\cdot\mu\nabla{} T
  - \nabla\cdot{} \left(p\sigma{}m\right)
  + \frac{1}{Re} \nabla\cdot\left(\tau{}\sigma{}m\right)
  + f_{b} \cdot{} m
  + \frac{1}{\sigma} q_{b}
\intertext{
