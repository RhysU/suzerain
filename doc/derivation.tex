...
\begin{align*}
  ...
  \tau_{0} &= p_{0}
  &
  f_{0} &= \frac{p_{0}}{l_{0}} % FIXME suspect units
% FIXME Working line
...
%To eliminate the presence of leading dimensional constants we require
%the following:
%\begin{align}
%  u_{0} &= \frac{x_{0}}{t_{0}}
%  &
%  \tau_{0} &= \frac{\mu_{0}}{t_{0}}
%  &
%  e_{0} &= u_{0}^{2}
%  &
%  p_{0} &= \rho_{0} u_{0}^{2}
%  \label{eq:rq_relationships}
%\end{align}
