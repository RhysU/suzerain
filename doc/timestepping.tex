...
%% Results at each step in the main algorithm
%\clearpage
%\begin{align*}
%&\text{begin}
%& a&=u(t)=u^{0}
...
%& b&=N(u^{0})
%\\
%a &\leftarrow{} \left(I+\Delta{}t\alpha_{1}L\right)a
%& a&=\left(I+\Delta{}t\alpha_{1}L\right)u^{0}
%& &
%\\
%a &\leftarrow{} a + \Delta{}t\gamma_{1}b
%& a&=\left(I+\Delta{}t\alpha_{1}L\right)u^{0} + \Delta{}t\gamma_{1}N(u^{0})
%\\
%a &\leftarrow{} \left(I-\Delta{}t\beta_{1}L\right)^{-1}a
%& a&=u^{1}
%\\
%b &\leftarrow{} \left(I+\Delta{}t\alpha_{2}L\right)a + \Delta{}t\zeta_{1}b
%& &
%& b&=\left(I+\Delta{}t\alpha_{2}L\right)u^{1} + \Delta{}t\zeta_{1}N(u^{0})
%\\
%a &\leftrightarrow{} b
%& a&=\left(I+\Delta{}t\alpha_{2}L\right)u^{1} + \Delta{}t\zeta_{1}N(u^{0})
%& b&=u^{1}
%\\
%b &\leftarrow{} N(b)
%& &
%& b&=N(u^{1})
%\\
%a &\leftarrow{} a + \Delta{}t\gamma_{2}b
%& a&=\left(I+\Delta{}t\alpha_{2}L\right)u^{1}
%    + \Delta{}t\gamma_{2}N(u^{1})
%    + \Delta{}t\zeta_{1}N(u^{0})
%\\
%a &\leftarrow{} \left(I-\Delta{}t\beta_{2}L\right)^{-1}a
%& a&=u^{2}
%\\
%b &\leftarrow{} \left(I+\Delta{}t\alpha_{3}L\right)a + \Delta{}t\zeta_{2}b
%& &
%& b&=\left(I+\Delta{}t\alpha_{3}L\right)u^{2} + \Delta{}t\zeta_{2}N(u^{1})
%\\
%a &\leftrightarrow{} b
%& a&=\left(I+\Delta{}t\alpha_{3}L\right)u^{2} + \Delta{}t\zeta_{2}N(u^{1})
%& b&=u^{2}
%\\
%b &\leftarrow{} N(b)
%& &
%& b&=N(u^{2})
%\\
%a &\leftarrow{} a + \Delta{}t\gamma_{3}b
%& a&=\left(I+\Delta{}t\alpha_{3}L\right)u^{2}
%    + \Delta{}t\gamma_{3}N(u^{2})
%    + \Delta{}t\zeta_{2}N(u^{1})
%\\
%a &\leftarrow{} \left(I-\Delta{}t\beta_{3}L\right)^{-1}a
%& a&=u^{3}
%\\
%&\text{end}
%& a&=u(t+\Delta{}t)=u^{3}
